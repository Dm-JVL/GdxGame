...
public class Map {
    public enum wallType {
        HARDv(0, 5, true), SOFT (1, 3, true), INDERSTRUCTABLE (2, 1, false);
        int index;
        int maxHp;
    ...
    public Map(TextureAtlas atlas) {
        this.walls = new TextureRegion(atlas.findRegion("walls")).split(CELL_SIZE, CELL_SIZE);
