...
public class BulletEmitter {
    ...
    public static final int MAX_BULLET_counts = 500;

    public BulletEmitter(TextureAtlas atlas) {
        this.bulletTexture = atlas.findRegion("projectille16");
        this.bullets = new Bullet[MAX_BULLET_counts];
        for (int i = 0; i < MAX_BULLET_counts; i++) {
